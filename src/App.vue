...
<template>
  ...
  <main class="flex justify-center p-12">
    <div class="w-full md:w-[56%]">
      ...
      <br />
      <section>
        <h1 class="text-xl font-bold font-sans pb-1">About</h1>
        <p class="text-pretty text-xs text-gray-500">{{ about }}</p>
      </section>
      <br />
      <section>
        <h1 class="text-xl font-bold font-sans pb-2">Work Experience</h1>
      ...
      <br />
      <section>
        <h1 class="text-xl font-bold font-sans pb-2">Education</h1>
        <AppEducation
      ...
      <br />
      <section>
        <h1 class="text-xl font-bold font-sans pb-2">Skills</h1>
      ...
      <br />
      <section>
        <h1 class="text-xl font-bold font-sans pb-2">Projects</h1>
